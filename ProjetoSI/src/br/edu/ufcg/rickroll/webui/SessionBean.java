...
public class SessionBean {
    ...
    public String nomePostador(String idMusica){
        //TODO
    ...
    public String getNameUsuarioLogado() throws SessaoIDException{
        return Conversador.sistema.getUsuario(Conversador.sistema.getUserID(sessaoID)).getNome();
    }
    ...
    public void mudarOrdenacao() throws SessaoIDException, RegraDeComposicaoException{
        if(ordenacao.equals("Mais Recentes Primeiro")){
            Conversador.sistema.setRegraDeComposicao(sessaoID, Conversador.sistema.getPrimeiraRegraDeComposicao());
        }
        if(ordenacao.equals("Mais favoritos Primeiro")){
            Conversador.sistema.setRegraDeComposicao(sessaoID, Conversador.sistema.getSegundaRegraDeComposicao());
        }
        else{
            Conversador.sistema.setRegraDeComposicao(sessaoID, Conversador.sistema.getTerceiraRegraDeComposicao());
        }
    ...
    public List<String> getMusicas(){
        ...
        try {
            ...
            if ( tamanho < posicaoMusicas + 6){
                ids = Conversador.sistema.getTimeLine(sessaoID).subList(posicaoMusicas, tamanho);
            }
            else{
                ids = Conversador.sistema.getTimeLine(sessaoID).subList(posicaoMusicas, posicaoMusicas + 6);
            }
        } catch (SessaoIDException ex) {
    ...
    public boolean hasMusicasMaisAntigas(){
        try {
            return posicaoMusicas + 6 < Conversador.sistema.getTimeLine(sessaoID).size();
        } catch (SessaoIDException ex) {
   ...
   public List<String> getSeguidores() throws Exception {
    ...
    public void favoritarMusica(String mus) throws Exception{
      ...
      public String nomeUsuario(String str){
